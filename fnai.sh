...
if [ "$CONNECT_TO_TESTNET" = true ]; then
    ...
    echo_green ">> Server is connected to Testnet."
fi
...
if [ -n "$CPU_ONLY" ] || ! command -v nvidia-smi &> /dev/null; then
    ...
    echo_green ">> Binding process to CPU cores..."
    CPU_CORES="0-3"  # Adjust according to your machine
    taskset -c $CPU_CORES python -m hivemind_exp.gsm8k.train_single_gpu \
